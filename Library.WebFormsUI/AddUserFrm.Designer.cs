namespace Library.WebFormsUI
{
	partial class AddUserFrm
	{
		...
		private void InitializeComponent()
		{
			...
			PasswordTbx = new SiticoneWinFormsUI.SiticoneTextbox();
			...
			CloseBtn.Location = new Point(385, 534);
			...
			SaveBtn.Location = new Point(170, 534);
			...
			EmailTbx.Location = new Point(142, 446);
			...
			EmailTbx.PlaceholderText = "E-mail Adresi";
			EmailTbx.Radius = 25;
			EmailTbx.RightToLeft = RightToLeft.No;
			EmailTbx.ShowPasswordOnFocus = false;
			EmailTbx.Size = new Size(452, 51);
			EmailTbx.TabIndex = 19;
			...
			PhoneNoTbx.Location = new Point(142, 362);
			...
			PhoneNoTbx.Size = new Size(452, 51);
			PhoneNoTbx.TabIndex = 17;
			PhoneNoTbx.TextColor = Color.Black;
			PhoneNoTbx.TrimStartEndSpaces = false;
			// 
			// PasswordTbx
			// 
			PasswordTbx.AlwaysRadial = true;
			PasswordTbx.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			PasswordTbx.AutoRadial = true;
			PasswordTbx.BorderColorOne = Color.FromArgb(170, 164, 213);
			PasswordTbx.BorderColorTwo = Color.FromArgb(170, 164, 213);
			PasswordTbx.BorderRadiusLowerLeft = true;
			PasswordTbx.BorderRadiusLowerRight = true;
			PasswordTbx.BorderRadiusUpperLeft = true;
			PasswordTbx.BorderRadiusUpperRight = true;
			PasswordTbx.BorderThickness = 1;
			PasswordTbx.ControlBackColor = Color.FromArgb(255, 255, 255);
			PasswordTbx.ControlBorderStyle = SiticoneWinFormsUI.Helpers.DrawingStyle.SiticoneDrawingStyle.Solid;
			PasswordTbx.EnableRightToLeft = false;
			PasswordTbx.ErrorColor = Color.Red;
			PasswordTbx.Font = new Font("Arial", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 162);
			PasswordTbx.IsPassword = true;
			PasswordTbx.IsReadonly = false;
			PasswordTbx.IsRequired = false;
			PasswordTbx.Location = new Point(142, 218);
			PasswordTbx.MakeLowercase = false;
			PasswordTbx.MakeUppercase = false;
			PasswordTbx.MinimumSize = new Size(150, 30);
			PasswordTbx.Name = "PasswordTbx";
			PasswordTbx.OnFocusBorderColorOne = Color.FromArgb(118, 0, 235);
			PasswordTbx.OnFocusBorderColorTwo = Color.FromArgb(118, 0, 235);
			PasswordTbx.OnHoverBorderColorOne = Color.FromArgb(157, 150, 207);
			PasswordTbx.OnHoverBorderColorTwo = Color.FromArgb(157, 150, 207);
			PasswordTbx.PlaceholderText = "Şifre";
			PasswordTbx.Radius = 25;
			PasswordTbx.RightToLeft = RightToLeft.No;
			PasswordTbx.ShowPasswordOnFocus = false;
			PasswordTbx.Size = new Size(452, 51);
			PasswordTbx.TabIndex = 16;
			PasswordTbx.TextColor = Color.Black;
			PasswordTbx.TrimStartEndSpaces = false;
			// 
			// UserNameTbx
			// 
			...
			UserNameTbx.Location = new Point(142, 127);
			...
			UserNameTbx.Size = new Size(452, 51);
		...
		private SiticoneWinFormsUI.SiticoneTextbox PasswordTbx;
