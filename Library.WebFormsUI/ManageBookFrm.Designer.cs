namespace Library.WebFormsUI
{
	partial class ManageBookFrm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ManageBookFrm));
			...
			RefreshBtn.Location = new Point(929, 143);
			...
			SearchTbx.Size = new Size(879, 62);
			...
			AddBookBtn.Location = new Point(37, 52);
			...
			AddBookBtn.Text = "Yeni Kitap Ekle";
			...
			UpdateBookBtn.Location = new Point(309, 52);
			...
			DeleteBookBtn.Location = new Point(591, 52);
			...
			materialDivider1.Location = new Point(37, 221);
			...
			dataGridView1.Location = new Point(37, 271);
